 ...
 * @author user
 */
public class JFManejoArchivos extends javax.swing.JFrame {
    JFileChooser seleccionado = new JFileChooser();
    File archivo;
    ManejoA gestion = new ManejoA();

    /**
     * Creates new form JFManejoArchivos
     */
    public JFManejoArchivos() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("MANEJO DE ARCHIVOS TXT");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFManejoArchivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFManejoArchivos().setVisible(true);
            }
        });
    }
